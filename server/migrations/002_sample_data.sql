...
VALUES
    ...
    ('admin@example.com', '+48 555 000 333', 'admin', '$argon2id$v=19$m=65536,t=1,p=1$rziInIOuKR9LrjujNEuCDQ$B4ZJZ4sV/fM614LVzNmwv3MWoVp3u5XImqbkee1H9g4', 0); -- password: admin
