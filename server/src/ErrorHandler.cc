...
ErrorHandler::handleError(oatpp::web::protocol::http::Status const& status, oatpp::String const& message, oatpp::web::protocol::http::Headers const& headers)
{
    ...
    auto response = ResponseFactory::createResponse(status, objectMapper_->writeToString(status_dto));
